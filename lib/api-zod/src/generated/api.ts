...
export const GetTaxReturnResponse = zod.object({
  ...
  qbiLossCarryforwardRemaining: zod.number().nullish(),
...
export const ListAdjustmentsResponseItem = zod.object({
  ...
  adjustmentType: zod.enum([
    ...
    "household_employee_cash_wages",
    "household_employee_futa_wages",
    "clergy_housing_allowance",
    "statutory_employee_income",
    "church_employee_income",
    "se_optional_method_nonfarm",
    "crypto_staking_income",
    "crypto_mining_income",
    "residential_clean_energy_carryforward",
    "qbi_loss_carryforward",
    "bonus_depreciation_basis_obbba",
    "qbi_w2_wages",
    "qbi_ubia",
    "qsbs_exclusion_pct",
    "out_of_state_muni_interest",
...
export const ListRentalPropertiesResponseItem = zod.object({
  ...
  fullyDisposedThisYear: zod.boolean().optional(),
  suspendedLossCarryforward: zod.number().nullish(),
  notes: zod.string().nullish(),
  createdAt: zod.coerce.date(),
  updatedAt: zod.coerce.date(),
});
