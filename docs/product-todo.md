...
- [ ] `[ENH]` **Quick state wins** (PREP-Q3) — **Yonkers PIT** (flat % of NY liability, ~16% add-on, trivial + high NY-metro frequency); WI std-ded high-AGI phase-out; CT pension/SS phase-out (currently over-taxes); NJ retirement-exemption cap; VT dependent exemption + IN-112 SS exclusion. (hours–days each)
