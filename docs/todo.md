...
| # | Item | Effort | Why |
|---|---|---|---|
| H1 | **Catalog v1.10 — 47 of ~90 shipped (audited)** | ~35 strategies remain in canonical universe | **SHIPPED so far (v1.10 = 57 total — 52 G1 + 5 G4):** G1.1-G1.10 (Phase G baseline) + v1.2-v1.9 batches + **G1.57 NQDC §409A, G1.58 state residency change, G1.59 Coverdell ESA §530, G1.60 §41(h) R&D Payroll Election, G1.61 §221 student loan interest** (v1.10 batch 2026-05-27). All 57 strategies audited (`docs/planning-strategy-audit.md`) — IRC + TY2024/2025 limits verified. **Remaining (~35):** CLT income-tax, §1374 BIG, §338(h)(10), §199A variants, §401(a)(17)/§415(c) max-out, NUA Section 1 / in-service, Adoption Credit §23, §47 historic rehab, §45S FMLA credit, WOTC §51, §44 disabled access, multi-state NR optimization, §351 contribution, §1059 extraordinary div, §453 partial-installment, §168(k) bonus election in/out, NUA Solo 401(k), rollover-IRA→401(k) for backdoor pro-rata fix, etc. Each ~2-4 hrs. |
