...
| # | Item | Effort | Why |
|---|---|---|---|
| H1 | **Catalog v1.7 — 32 of 65-80 shipped (audited)** | ~30-45 strategies remain in canonical universe | **SHIPPED so far (v1.7 = 42 total — 37 G1 + 5 G4):** G1.1-G1.10 (Phase G baseline), G1.11 QCD, G1.12 appreciated stock, G1.13 Augusta, G1.14 HSA, G1.15 NUA, G1.16 Mega-Backdoor Roth, G1.17 S-corp comp, G1.18 REPS, G1.19 CRT, G1.20 conservation easement, G1.21 §1031, G1.22 pre-RMD ladder, G1.23 cost seg, G1.24 QOZ, G1.26 backdoor Roth, G1.27 inherited IRA, G1.28 DB plan, G1.29 §529→Roth, G1.31 Saver's, G1.32 DCFSA, G1.33 EV credit, G1.34 §25D, G1.36 R&D §41, G1.37 §25C, G1.39 §1202 QSBS, G1.40 §1244, G1.45 §121 home sale, **G1.46 spousal IRA, G1.47 §453, G1.48 §83(b), G1.49 family employment, G1.51 AOC vs LLC** (v1.7 batch 2026-05-27). All 42 strategies audited (see `docs/planning-strategy-audit.md`) — IRC + TY2024/2025 limits verified. **Remaining (~30):** NQDC §409A, CLT, §1374 BIG, §338(h)(10), §199A optimization variants, §401(a)(17)/§415(c) max-out, §1045 QSBS rollover, ACA §36B reconciliation, wash-sale proactive, NUA Section 1 / in-service, §72(t) SEPP early retirement, family LP / FLP discount, etc. Each ~2-4 hrs w/ H2 wiring. |
