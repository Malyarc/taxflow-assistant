...
| # | Item | Effort | Why |
|---|---|---|---|
| H1 | **Catalog v1.9 — 42 of ~90 shipped (audited)** | ~40 strategies remain in canonical universe | **SHIPPED so far (v1.9 = 52 total — 47 G1 + 5 G4):** G1.1-G1.10 (Phase G baseline) + v1.2-v1.8 batches + **G1.52 estimated-tax safe harbor §6654, G1.53 kiddie tax §1(g), G1.54 §183 hobby loss qualification, G1.55 custodial Roth IRA for child, G1.56 specific-share-ID lot selection** (v1.9 batch 2026-05-27). All 52 strategies audited (`docs/planning-strategy-audit.md`) — IRC + TY2024/2025 limits verified. **Remaining (~40):** NQDC §409A, CLT, §1374 BIG, §338(h)(10), §199A optimization variants, §401(a)(17)/§415(c) max-out, NUA Section 1 / in-service, Adoption Credit §23, §47 historic rehab, §45S FMLA credit, WOTC §51, §44 disabled access credit, state residency change planning, multi-state NR credit optimization, §351 contribution, §1059 extraordinary dividend, §453 partial-installment, §183 audit-defense docs, §168(k) bonus election in/out, etc. Each ~2-4 hrs. |
