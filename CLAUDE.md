...
- **Test files (current set, ~2,950+ assertions across 40 suites — ALL 10 K-list federal-engine gaps + ALL 4 state-engine gaps closed; C-batch shipped 2026-05-26; **Phase H FULLY COMPLETE 2026-05-27** including all sub-gaps + H1 catalog continuation through v1.10: 12/12 H items + H3 multi-year detector wiring + H5 4 new asset types + H6 Form 8606 Part III + H8 LLM-discovery rule-engine verification + **H1 catalog v1.10 (37 NEW strategies total) — TOTAL 57 catalog strategies** (52 G1 + 5 G4). Plus: validation audit (`docs/planning-strategy-audit.md` — IRC + TY2024/2025 limits verified for all 57) + end-to-end scenarios test file (10 realistic CPA archetypes). ~319 NEW hand-calc'd assertions in the Phase H sub-gap session (28 H3-wiring + 40 H6-PartIII + 23 H8-verifier + 24 v1.4 + 26 v1.5 + 24 v1.6 + 20 v1.7 + 21 v1.8 + 20 v1.9 + 20 v1.10 + 69 scenarios); previous Phase H batch 222; Phase G4 70 + G5 21; Phase E 235; deep-audit 210, accuracy-audit 97; 0 documented federal/state gaps, 4 C-batch sub-gaps still tracked):**
  | File | Needs API |
  |---|---|
  ...
  | `tax-engine-planning-tests.ts` | no (316 hand-calc'd tests: 10 original G1 detectors + G2 scoring helpers + 28 H3 multi-year wiring + 24 H1 v1.4 + 26 H1 v1.5 + 24 H1 v1.6 + 20 H1 v1.7 + 21 H1 v1.8 + 20 H1 v1.9 + **20 H1 v1.10** (G1.57 NQDC §409A / G1.58 state residency / G1.59 Coverdell ESA / G1.60 §41(h) R&D payroll / G1.61 §221 student loan). Phase G + H.) |
  | `tax-engine-planning-scenarios-tests.ts` | no (69 end-to-end assertions across 10 realistic CPA archetypes: (1) tech founder SF, (2) retired couple FL, (3) high-SE professional FL, (4) working parents IL MFJ, (5) real-estate investor TX MFJ, (6) low-income retirement saver OH, (7) FIRE-movement age 55, (8) SE solo on ACA age 40, (9) HNW family with kids + side SE + brokerage CA MFJ, **(10) high-income tech executive CA age 48**. Each scenario: complete TaxReturnInputs + assertions on which strategies fire / suppress + estSavings ranges.) |
