...
- **Test files (current set, 2,300+ assertions across 35 suites — ALL 10 K-list federal-engine gaps + ALL 4 state-engine gaps closed; C-batch 2026-05-26 shipped 6 new items (C1 coverage matrix + C4 Form 1040-X + C5 §1031 + C6 ESPP/ISO disqualifying + C7 §163(j)+§461(l) + C8 Form 4868) with 178 new hand-calc'd assertions across 5 new pure-engine test files; Phase G4 multi-year shipped with 70 new hand-calc assertions; Phase G5 Pro-tier gate shipped with 21 new dual-state integration assertions; Phase E shipped ALL 14 items with 235 hand-calc assertions total; deep-audit suite still 210 assertions, accuracy-audit 97 assertions; 0 documented federal/state gaps, 4 C-batch sub-gaps tracked):**
  | File | Needs API |
  |---|---|
