...
- **Test files (current set, ~2,850+ assertions across 40 suites — ALL 10 K-list federal-engine gaps + ALL 4 state-engine gaps closed; C-batch shipped 2026-05-26; **Phase H FULLY COMPLETE 2026-05-27** including all sub-gaps + H1 catalog continuation through v1.8: 12/12 H items + H3 multi-year detector wiring + H5 4 new asset types + H6 Form 8606 Part III + H8 LLM-discovery rule-engine verification + **H1 catalog v1.8 (5 v1.4 + 6 v1.5 + 6 v1.6 + 5 v1.7 + 5 v1.8 = 27 NEW strategies) — TOTAL 47 catalog strategies** (42 G1 + 5 G4). Plus: validation audit (`docs/planning-strategy-audit.md` — IRC + TY2024/2025 limits verified for all 47) + end-to-end scenarios test file (8 realistic CPA archetypes). ~253 NEW hand-calc'd assertions in the Phase H sub-gap session (28 H3-wiring + 40 H6-PartIII + 23 H8-verifier + 24 v1.4 + 26 v1.5 + 24 v1.6 + 20 v1.7 + 21 v1.8 + 47 scenarios); previous Phase H batch 222; Phase G4 70 + G5 21; Phase E 235; deep-audit 210, accuracy-audit 97; 0 documented federal/state gaps, 4 C-batch sub-gaps still tracked):**
  | File | Needs API |
  |---|---|
  ...
  | `tax-engine-planning-tests.ts` | no (276 hand-calc'd tests: 10 original G1 detectors + G2 scoring helpers + 28 H3 multi-year wiring + 24 H1 v1.4 + 26 H1 v1.5 + 24 H1 v1.6 + 20 H1 v1.7 + **21 H1 v1.8** (G1.30 ACA PTC / G1.41 §1045 / G1.42 SEHI / G1.43 wash-sale proactive / G1.50 §72(t) SEPP). Phase G + H.) |
  | `tax-engine-planning-scenarios-tests.ts` | no (47 end-to-end assertions across 8 realistic CPA archetypes: (1) tech founder SF, (2) retired couple FL, (3) high-SE professional FL, (4) working parents IL MFJ, (5) real-estate investor TX MFJ, (6) low-income retirement saver OH, **(7) FIRE-movement client age 55, (8) SE solo on ACA age 40**. Each scenario: complete TaxReturnInputs + assertions on which strategies fire / suppress + estSavings ranges.) |
