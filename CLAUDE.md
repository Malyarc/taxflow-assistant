...
- **Test files (current set, 1,584 assertions across 26 suites — K1 SE+W2 Sch SE Line 9 and K2 Form 8959 Additional Medicare both shipped 2026-05-23 PM, closing 2 of 10 documented federal gaps; deep-audit suite now 125 assertions; AI-overlay 33 included):**
  | File | Needs API |
  |---|---|
  ...
  | `tax-engine-deep-audit-tests.ts` | no (125 deep-audit: per-calc edge cases, 20 client archetypes, invariants, K1+K2 closure cases; see `docs/accuracy-audit/deep-audit-2026-05-23.md`) |
...
- **Federal-engine gaps surfaced in the 2026-05-23 DEEP audit** (`docs/accuracy-audit/deep-audit-2026-05-23.md`, K-list, all tracked as failing assertions in `tax-engine-deep-audit-tests.ts`):
