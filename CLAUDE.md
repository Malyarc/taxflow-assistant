...
- **Test files (current set, ~2,750+ assertions across 39 suites — ALL 10 K-list federal-engine gaps + ALL 4 state-engine gaps closed; C-batch shipped 2026-05-26; **Phase H FULLY COMPLETE 2026-05-27** including all sub-gaps + H1 catalog continuation: 12/12 H items + H3 multi-year detector wiring (G1.3/G1.4/G1.8) + H5 4 new asset types (ESPP / ISO AMT-credit / restricted-stock pre-§83(b) / crypto) + H6 Form 8606 Part III Roth distribution basis recovery + H8 LLM-discovery rule-engine verification + **H1 catalog v1.6 (5 v1.4 + 6 v1.5 + 6 v1.6 = 17 NEW strategies)** — TOTAL 37 catalog strategies. ~165 NEW hand-calc'd assertions in the Phase H sub-gap session (28 H3-wiring + 40 H6-PartIII + 23 H8-verifier + 24 v1.4 + 26 v1.5 + 24 v1.6); previous Phase H batch 222; Phase G4 70 + G5 21; Phase E 235; deep-audit 210, accuracy-audit 97; 0 documented federal/state gaps, 4 C-batch sub-gaps still tracked):**
  | File | Needs API |
  |---|---|
  ...
  | `tax-engine-planning-tests.ts` | no (235 hand-calc'd tests: 10 original G1 detectors + G2 scoring helpers + 28 H3 multi-year wiring (G1.3 bunching / G1.4 Roth / G1.8 DAF) + 24 H1 v1.4 (G1.21 §1031 / G1.22 pre-RMD ladder / G1.23 cost seg / G1.24 opportunity zones / G1.26 backdoor Roth) + 26 H1 v1.5 (G1.27 inherited IRA / G1.28 DB plan / G1.33 EV credit / G1.34 §25D / G1.39 QSBS / G1.45 §121 home sale) + **24 H1 v1.6** (G1.29 §529→Roth / G1.31 Saver's Credit / G1.32 DCFSA / G1.36 R&D §41 / G1.37 §25C heat pump / G1.40 §1244 ordinary loss). Phase G + H.) |
